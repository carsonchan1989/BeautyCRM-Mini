    ...
    try:
        ...
        for service in services:
            ...
            if key not in seen_keys:
                ...
                # 确保客户名称字段填充
                if not service.customer_name and customer:
        ...
        for service in unique_services:
            ...
            # 确保customer_name字段存在
            if not service_dict.get('customer_name'):
                service_dict['customer_name'] = customer.name
                
            services_json.append(service_dict)
